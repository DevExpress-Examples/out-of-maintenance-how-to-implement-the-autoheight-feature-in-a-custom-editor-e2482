...
Namespace WindowsApplication1
	...
	Public Class RepositoryItemMyCheckedComboBoxEdit
		...
		Public Shared Sub Register()
			EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(EditorName, GetType(MyCheckedComboBoxEdit), GetType(RepositoryItemMyCheckedComboBoxEdit), GetType(MyCheckedComboBoxEditViewInfo), New MyButtonEditPainter(), True, Nothing))
		End Sub
